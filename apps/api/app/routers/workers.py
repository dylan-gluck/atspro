...
async def scale_resume_parsing_workers(
    target_count: int, current_user: dict = Depends(get_current_user)
) -> Dict[str, Any]:
    """
    ...
    if target_count < 1 or target_count > 10:
        raise HTTPException(
            status_code=422, detail="Target count must be between 1 and 10"
        )
    ...
    try:
        ...
        return {
            ...
            "data": {"target_count": target_count, "current_status": status},
        }
