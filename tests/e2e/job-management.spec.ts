...
test.describe('Job Management', () => {
	...
	test('should redirect to auth for unauthenticated users accessing new job page', async ({ page }) => {
	...
	test('should redirect to auth for unauthenticated users accessing job edit page', async ({ page }) => {
	...
	test('should redirect to auth for unauthenticated users accessing job details', async ({ page }) => {
	...
	test('should redirect to auth for unauthenticated users accessing dashboard', async ({ page }) => {
